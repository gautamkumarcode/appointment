  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        ...
        role: 'assistant',
        content:
          "I'm currently unavailable, but I'd love to help you book an appointment! Please feel free to browse our services and available time slots above, or contact us directly if you need assistance.",
        timestamp: new Date(),
      };
